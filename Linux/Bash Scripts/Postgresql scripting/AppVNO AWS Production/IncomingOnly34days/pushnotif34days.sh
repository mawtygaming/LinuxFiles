...
fileLoc="/home/ec2-user/PushNotifcation/IncomingOnly34days/list34days.tmp"
# URL to POST request
...
# Logs location
logsLoc="/home/ec2-user/PushNotifcation/IncomingOnly34days/logs.tmp"
# current number
currentNumLoc="/home/ec2-user/PushNotifcation/IncomingOnly34days/currentNum.tmp"
...
# This command is to list mobile numbers from users table
cd /home/ec2-user/PushNotifcation/IncomingOnly34days/
./select34days.py
