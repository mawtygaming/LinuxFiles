...
fileLoc="/home/ec2-user/PushNotification/Inactive31days/list31days.tmp"
# Get the current date and time
now=$(date '+%b %d %Y %H:%M:%S')
# Logs location
logsLoc="/home/ec2-user/PushNotification/Inactive31days/logs.tmp"
# current number
currentNumLoc="/home/ec2-user/PushNotification/Inactive31days/currentNum.tmp"
