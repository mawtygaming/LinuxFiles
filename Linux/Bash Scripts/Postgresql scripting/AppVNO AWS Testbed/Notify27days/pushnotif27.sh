...
fileLoc="/home/ec2-user/PushNotification/Notify27days/list27days.tmp"
# URL to POST request
...
# Logs location
logsLoc="/home/ec2-user/PushNotification/Notify27days/logs.tmp"
...
# psql -d $database -t -c "SELECT id FROM svn WHERE expiry_date::DATE - current_date = 3"
